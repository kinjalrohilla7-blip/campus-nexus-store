...
export const PRODUCTS: Product[] = [
  ...
  { id: "p10", name: "Studio Headphones Pro", description: "Active noise-cancelling over-ear headphones with 40-hour battery.", category: "Electronics", price: 3999, originalPrice: 5999, rating: 4.8, reviews: 3450, stock: 44, badge: "Best Audio", gradient: g.violet ?? g.rose, icon: "Headphones" },
  ...
  { id: "p39", name: "System Design Primer", description: "Master HLD & LLD for senior software engineering interviews.", category: "Career Resources", price: 699, originalPrice: 1299, rating: 4.9, reviews: 980, stock: 999, badge: "Pro", gradient: g.violet ?? g.rose, icon: "Network" },
